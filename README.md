...
The PhilipsHueAPI PowerShell Module allows you to detect a Philips Hue Bridge in your Network, connect to it, create new  api user and get all lights that are installed in your environment. 
